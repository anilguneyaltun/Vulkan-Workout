...
void PhCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 upDir) { 
    const glm::vec3 w{glm::normalize(direction)};
    const glm::vec3 u{glm::normalize(glm::cross(w, upDir))};
...
void PhCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 upDir) { 
    setViewDirection(position, target - position, upDir);
}

void PhCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) { 
